  ...
  return (
    <div className={style['field']} >
      <div className={style['inner-field']}>
        <input className={`${style['text']} ${isError ? style['text-error'] : ""}`} type='text' placeholder={placeholder} value={text} onChange={onTextChange} onFocus={onFocused} onBlur={onBlured}></input>
